...
.bbb :hover {
  opacity: 0.8;
    ...
    <body>
        ...
        <br><font color='red'>
        Notice Submission Window for Computer Science Department
        </font>
...
$qry = "SELECT `i_sub` FROM `i_notice` WHERE i_id=$saaa "; 
 ...
 ?>
        ...
        <form  action="compsciadd.php" method="post">
...
$qry = "INSERT INTO `s_notice`( `m_date`,`m_sub`, `m_desc`) VALUES ('$md','$ms','$mdc')"; 
